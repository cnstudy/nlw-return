...
export function ScreeshotButton({onScreenshotTook, screenshot}: ScreenshotButtonProps) {

    const [isTakingScreenshot, setIsTakingScreenshot] = useState(false)

    async function rendleTakeScreenshot() {
    ...
    if(screenshot){
        return (
            ...
            style={{
                ...
                <Trash weight="fill" alt="Apagar Screenshot"/>
            </button>
        )
    }
